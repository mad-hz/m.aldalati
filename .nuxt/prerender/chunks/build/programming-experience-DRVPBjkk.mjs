...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="space-y-3"><h2 class="text-2xl font-bold md:text-3xl">My Programming Experience</h2><p class="text-lg text-gray-800"> I have been coding most of the time in Laravel, which is a PHP framework. It bacame the central of my development process. Laravel is powerful and help me build efficient applications in no time. Next to it, I use PostgreSQL and MySQL to ensure I handle data correctly. I also work on the front end, where I use Nuxt.js and Tailwindcss to create a resposive appealing applications. </p></div><figure><img class="w-full object-cover rounded-xl"${ssrRenderAttr("src", _imports_3)} alt="Programming Experience"><figcaption class="mt-3 text-sm text-center text-gray-500 dark:text-neutral-500"></figcaption></figure><p class="text-lg text-gray-800">Away from coding, I manage deployments of websites using cPanel, where I have configured next to it an email service with Roundcube. All the technologies that I have listed make sure I deploy smooth, responsive and secure websities.</p><nav class="flex justify-between items-center gap-x-1" aria-label="Pagination">`);
      _push(ssrRenderComponent(_component_nuxt_link, {
...
//# sourceMappingURL=programming-experience-DRVPBjkk.mjs.map
