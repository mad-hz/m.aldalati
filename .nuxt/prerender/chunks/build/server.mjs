...
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/mad/Desktop/HZ/PCO/Assignments/preparation-assignment/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///Users/mad/Desktop/HZ/PCO/Assignments/preparation-assignment/node_modules/unhead/dist/index.mjs';
...
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/mad/Desktop/HZ/PCO/Assignments/preparation-assignment/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/mad/Desktop/HZ/PCO/Assignments/preparation-assignment/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/mad/Desktop/HZ/PCO/Assignments/preparation-assignment/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, isScriptProtocol, withQuery, withTrailingSlash, withoutTrailingSlash } from 'file:///Users/mad/Desktop/HZ/PCO/Assignments/preparation-assignment/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate } from 'file:///Users/mad/Desktop/HZ/PCO/Assignments/preparation-assignment/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./feedback-DsEm-usy.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-blogs-ict-field-of-work",
    path: "/blog/blogs/ict-field-of-work",
    component: () => import('./ict-field-of-work-Byg3rusx.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-blogs-profession",
    path: "/blog/blogs/profession",
    component: () => import('./profession-D9Q2hR1q.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-blogs-programming-experience",
    path: "/blog/blogs/programming-experience",
    component: () => import('./programming-experience-CtqP_1MQ.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-blogs-study-choice",
    path: "/blog/blogs/study-choice",
    component: () => import('./study-choice-DDzjZ8RT.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-blogs-swot",
    path: "/blog/blogs/swot",
    component: () => import('./swot-n8Lz9n1r.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
  ...
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DfyUib0n.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-BFfY7kc3.mjs').then((m) => m.default || m)
  },
  {
    name: "faq",
    path: "/faq",
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BePNKkDS.mjs').then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-BmutmcgV.mjs').then((m) => m.default || m)
  }
];
...
const _imports_0 = "" + __buildAssetsURL("logo.CgfLNvP4.png");
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7" }, _attrs))}><nav class="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-6 md:px-8 mx-auto"><div class="md:col-span-3">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img class="w-28 h-auto"${ssrRenderAttr("src", _imports_0)} alt="Logo Image"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            class: "w-28 h-auto",
  ...
  _push(`</div><div class="flex items-center gap-x-1 md:gap-x-2 ms-auto py-1 md:ps-6 md:order-3 md:col-span-3">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    to: "/contact",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto" }, _attrs))}><div class="text-center"><div class="flex justify-center items-center">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    to: "/",
    class: "w-4/12 sm:w-2/12 md:w-2/12 lg:w-1/12"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
  ...
  _push(`</div><div class="mt-3"><p class="text-gray-500">© ${ssrInterpolate($data.currentYear)} Mohamad Aldalati. All rights reserved.</p><p class="text-gray-500">Also know as `);
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode("MAD NL")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`.</p></div><div class="mt-3 space-x-2">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"${_scopeId}><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"${_scopeId}></path></svg>`);
      } else {
        return [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CBzDC3Fa.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, entry$1 as default, injectHead as i, resolveUnrefHeadInput as r, useRuntimeConfig as u };
