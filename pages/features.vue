                    ...
                    <nav class="grid gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist" aria-orientation="vertical">
                        <button type="button"
                            ...
                            <span class="flex gap-x-6">
                                <svg class="shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-lime-500 text-gray-800"
                                ...
                                <span class="grow">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-lime-500 text-gray-800">Advanced
                                        tools</span>
                                    <span class="block mt-1 text-gray-800">I use frameworks and automated libraries to
                        ...
                        <button type="button"
                            ...
                            <span class="flex gap-x-6">
                                ...
                                <span class="grow">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-lime-500 text-gray-800">Smart
                                        dashboards</span>
                                    <span class="block mt-1 text-gray-800">Quickly done, easily customizable and start
                                        right off to manage your business.</span>
                                </span>
                            </span>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <span class="flex gap-x-6">
                                ...
                                <span class="grow">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-lime-500 text-gray-800">Powerful
                                        features</span>
                                    <span class="block mt-1 text-gray-800">Reduce time and effort on building modern
                                        look design and leave it on me.</span>
                                </span>
                            </span>
                        </button>
                    </nav>
                ...
                <div class="lg:col-span-6">
                    <div class="relative">
                        ...
                        <div class="hidden absolute top-0 end-0 translate-x-20 md:block lg:translate-x-20">
                            <svg class="w-16 h-auto text-lime-500" width="121" height="135" viewBox="0 0 121 135"
